...
- [x] getStarterPackListが5種類のパックを返す
- [x] 各パックにdisplayName, description, primaryTags, seedArticlesが含まれる
- [x] getStarterPack("custom")がnullを返す
- [x] 存在しないパックタイプでnullが返る
