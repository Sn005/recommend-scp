...
| ID                          | 名前                         | 概要                                               | ステータス |
| --------------------------- | ---------------------------- | -------------------------------------------------- | ---------- |
| [007-03-01](./007-03-01.md) | CIビルド検証ステップ追加     | ci.yml に `pnpm build` ステップを追加              | pending    |
| [007-03-02](./007-03-02.md) | api-serverバンドルビルド整備 | tsc → tsup に移行、スタンドアロン起動可能にする    | pending    |
| [007-03-03](./007-03-03.md) | packages/sharedビルド整備    | noEmit: true → tsup でトランスパイル済みJS出力する | pending    |
